...
import { getNumberSeparators, getNumberDecimalLimit, componentValueTypes, getComponentSavedTypes } from 'formiojs/utils/utils';
...
Formio.Components.addComponent('number', NumberComponent);
